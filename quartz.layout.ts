...
const githubSourceConfig = {
  repoLink: "https://github.com/Supakornn/notebook",
}
///////////////////////////////////////////////////
...
export const sharedPageComponents: SharedLayout = {
  ...
  header: [],
  afterBody: [
    Component.OnlyFor({ titles: [homepageTitle] }, Component.RecentNotes(recentNotesConfig)),
    Component.OnlyFor(
      { titles: [mapTitle] },
...
export const defaultContentPageLayout: PageLayout = {
  ...
  right: [Component.Graph(graphConfig), Component.Backlinks(backlinksConfig)],
}
...
export const defaultListPageLayout: PageLayout = {
  ...
  right: [Component.HiddenGlobalGraph(graphConfig)],
}
